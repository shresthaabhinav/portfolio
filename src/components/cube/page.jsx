...
function Cube() {
  ...
  const texture_1 = useLoader(TextureLoader, "img/abhi.webp");
  const texture_2 = useLoader(TextureLoader, "img/abhi.webp");
  const texture_3 = useLoader(TextureLoader, "img/abhi.webp");
  const texture_4 = useLoader(TextureLoader, "img/abhi.webp");
  const texture_5 = useLoader(TextureLoader, "img/abhi.webp");
  const texture_6 = useLoader(TextureLoader, "img/abhi.webp");
